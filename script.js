...
const translations = {
    ru: {
        ...
        'about.text1': 'Наша команда опытных барберов с многолетним опытом работы готова создать для вас идеальный образ. Мы следим за последними тенденциями в мире мужских стрижек и всегда рады предложить индивидуальный подход к каждому клиенту.',
        'about.text2': 'В нашем салоне царит атмосфера настоящего мужского клуба, где вы можете расслабиться и довериться профессионалам.',
        
        // Services section
        'services.title': 'Наши услуги',
        'services.service1.title': 'Стрижка "под насадку"',
        'services.service1.description': 'Профессиональная стрижка машинкой с использованием различных насадок',
        'services.service1.price': '300 руб.',
        'services.service2.title': 'Модельная стрижка',
        'services.service2.description': 'Создание стильного образа с учетом особенностей волос и формы лица',
        ...
        'master.description': 'Наш мастер демонстрирует высший уровень профессионализма. Каждое движение отточено до совершенства, каждая деталь продумана. С бритвой и расческой в руках он создает не просто стрижку, а настоящее произведение искусства, подчеркивающее вашу индивидуальность и стиль.',
        ...
        'tools.description': 'Мы используем только лучшее оборудование и инструменты, чтобы гарантировать безупречный результат каждой стрижки и бритья',
        ...
        'modal.message': 'Мы свяжемся с вами в ближайшее время для подтверждения записи.',
        'modal.button': 'Закрыть',
        
        // Alerts
        'alert.required': 'Пожалуйста, заполните все обязательные поля',
        'alert.success': 'Заявка успешно отправлена! Мы свяжемся с вами в ближайшее время.',
        'alert.error': 'Произошла ошибка при отправке заявки. Пожалуйста, попробуйте еще раз или свяжитесь с нами по телефону.'
    },
    en: {
        // Navigation
        'nav.home': 'Home',
        ...
        'about.text1': 'Our team of experienced barbers with years of experience is ready to create the perfect look for you. We follow the latest trends in men\'s haircuts and are always happy to offer an individual approach to each client.',
        'about.text2': 'Our salon has the atmosphere of a real men\'s club where you can relax and trust the professionals.',
        
        // Services section
        'services.title': 'Our Services',
        'services.service1.title': 'Clipper Cut',
        'services.service1.description': 'Professional clipper haircut using various attachments',
        'services.service1.price': '300 RUB',
        'services.service2.title': 'Style Cut',
        'services.service2.description': 'Creating a stylish look considering hair features and face shape',
        ...
        'master.description': 'Our master demonstrates the highest level of professionalism. Every movement is perfected to perfection, every detail is thought out. With a razor and comb in his hands, he creates not just a haircut, but a real work of art that emphasizes your individuality and style.',
        ...
        'tools.description': 'We use only the best equipment and tools to guarantee flawless results for every haircut and shave',
        ...
        'modal.message': 'We will contact you shortly to confirm your appointment.',
        'modal.button': 'Close',
        
        // Alerts
        'alert.required': 'Please fill in all required fields',
        'alert.success': 'Application successfully sent! We will contact you shortly.',
        'alert.error': 'An error occurred while sending the application. Please try again or contact us by phone.'
    }
};
...
document.getElementById('telegram-form').addEventListener('submit', function(e) {
    ...
    const message = formData.get('message') || app.getTranslation('contact.placeholder');

    // Validation
    if (!name || !phone || !service) {
        alert(app.getTranslation('alert.required'));
        return;
    }
    ...
    submitBtn.textContent = app.getTranslation('contact.button') + '...';
    ...
    .catch(error => {
        ...
        alert(app.getTranslation('alert.error'));
    })
    .finally(() => {
        // Restore button
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    images.forEach(img => {
        ...
        // Don't set opacity to 0 for preloaded images to avoid flash
        if (!img.complete) {
            img.style.opacity = '0';
